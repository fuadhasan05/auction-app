...
const FavItems = ({ bidItem, removeFavoriteItem }) => {
            ...
            <div className="flex flex-col gap-3 py-3 items-center">
                <div className=" flex flex-col justify-center w-full max-w-sm card bg-base-100 shrink-0">
                    <div className="flex justify-between p-2 items-center">
                        ...
                        <button onClick={() => removeFavoriteItem(bidItem)}
                            className='p-1 rounded-full hover:bg-red-300 hover:text-red-500 hover:cursor-pointer hover:scale-110 transition-all duration-300'>
                            <RxCross2 />
                        </button>
                    </div>
                </div>
